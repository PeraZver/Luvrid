...
int16_t int_acc_z = 0;
boolean vertical = LOW;    // Indikator jeli zastavica postavljena vertikalno ili se podiže
...
void RotateLamp(int omega) {
  ...
  int rot_offset = 100;      // There is non-zero sensor output when the lamp is not rotating.
